...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateTimer() {
      ...
      console.log("This is the seconds left after its been updated in the update timer function: " + secondsLeft)
    }
    ...
    function runQuiz() {    
      ...
      console.log("this is secondsleft in the runquiz: " + secondsLeft);
    ...
    function resetTimer() {
      console.log("this much seconds left: " + secondsLeft);
      console.log("this is the reset time: " + resetTime);
